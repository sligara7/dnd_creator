...
# Phase 2: Add factory-based endpoints alongside existing ones
# Phase 3: Gradually migrate existing endpoints to use factory
# Phase 4: Remove old endpoints and creators
# Phase 5: Add new content types easily through factory config
