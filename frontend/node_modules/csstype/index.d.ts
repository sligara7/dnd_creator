...
export interface StandardLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`ma-mode`** CSS property specifies the blending mode used in a mask border.
   *
  ...
  /**
   * The **`ma-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   *
   * **Initial value**: `0`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma-image-outset)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-ma-image-outset)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-outset
   */
  maskBorderOutset?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`ma-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   *
   * **Initial value**: `stretch`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma-image-repeat)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-ma-image-repeat)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-repeat
   */
  maskBorderRepeat?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`ma-slice`** CSS property divides the image set by `ma-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   *
   * **Initial value**: `0`
   ...
   * |                 Chrome                 | Firefox |                Safari                | Edge | IE  |
   * | :------------------------------------: | :-----: | :----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma-image-slice)_ |   No    |               **17.2**               | n/a  | No  |
   * |                                        |         | 3.1 _(-webkit-ma-image-slice)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-slice
   */
  maskBorderSlice?: Property.MaskBorderSlice | undefined;
  /**
   * The **`ma-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   *
   * **Initial value**: `none`
   ...
   * |                 Chrome                  | Firefox |                Safari                 | Edge | IE  |
   * | :-------------------------------------: | :-----: | :-----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma-image-source)_ |   No    |               **17.2**                | n/a  | No  |
   * |                                         |         | 3.1 _(-webkit-ma-image-source)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-source
   */
  maskBorderSource?: Property.MaskBorderSource | undefined;
  /**
   * The **`ma-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   *
   * **Initial value**: `auto`
   ...
   * |                 Chrome                 | Firefox |                Safari                | Edge | IE  |
   * | :------------------------------------: | :-----: | :----------------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma-image-width)_ |   No    |               **17.2**               | n/a  | No  |
   * |                                        |         | 3.1 _(-webkit-ma-image-width)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-width
   */
  maskBorderWidth?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`ma`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   ...
   * | 1 _-x-_ |         | 4 _-x-_  |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  maskClip?: Property.MaskClip | undefined;
  /**
   * The **`ma`** CSS property represents a compositing operation used on the current mask layer with the mask layers below it.
   *
  ...
  /**
   * The **`ma`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `ma` property.
   *
   * **Syntax**: `<ma>#`
   *
   * **Initial value**: `none`
  ...
  /**
   * The **`ma`** CSS property sets whether the mask reference defined by `ma` is treated as a luminance or alpha mask.
   *
   * **Syntax**: `<masking-mode>#`
   *
  ...
  /**
   * The **`ma`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `<geometry-box>#`
   *
   * **Initial value**: `border-box`
  ...
  /**
   * The **`ma`** CSS property sets the initial position, relative to the mask position layer set by `ma`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   *
  ...
  /**
   * The **`ma`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   *
   * **Initial value**: `repeat`
  ...
  /**
   * The **`ma`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   *
   * **Initial value**: `auto`
  ...
  /**
   * The **`ma`** CSS property sets whether an SVG `<mask>` element is used as a _luminance_ or an _alpha_ mask. It applies to the `<mask>` element itself.
   *
   * **Syntax**: `luminance | alpha`
   *
...
export interface StandardShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`ma`** CSS shorthand property lets you create a mask along the edge of an element's border.
   *
   * **Syntax**: `<'ma-source'> || <'ma-slice'> [ / <'ma-width'>? [ / <'ma-outset'> ]? ]? || <'ma-repeat'> || <'ma-mode'>`
   *
   * |              Chrome              | Firefox |             Safari             | Edge | IE  |
   * | :------------------------------: | :-----: | :----------------------------: | :--: | :-: |
   * | **1** _(-webkit-ma-image)_ |   No    |            **17.2**            | n/a  | No  |
   * |                                  |         | 3.1 _(-webkit-ma-image)_ |      |     |
   *
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
...
export interface VendorLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * If a `ma` is specified, `-webkit-ma` determines whether the mask image's position is fixed within the viewport, or scrolls along with its containing block.
   *
   * **Syntax**: `<attachment>#`
   *
   * **Initial value**: `scroll`
  ...
  /**
   * The **`-webkit-ma`** property specifies the manner in which multiple mask images applied to the same element are composited with one another. Mask images are composited in the opposite order that they are declared with the `-webkit-ma` property.
   *
  ...
  /**
   * The `-webkit-ma-x` CSS property sets the initial horizontal position of a mask image.
   *
  ...
  /**
   * The `-webkit-ma-y` CSS property sets the initial vertical position of a mask image.
   *
  ...
  /**
   * The `-webkit-ma-x` property specifies whether and how a mask image is repeated (tiled) horizontally.
   *
  ...
  /**
   * The `-webkit-ma-y` property sets whether and how a mask image is repeated (tiled) vertically.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   *
   * **Initial value**: `repeat`
...
export interface VendorShorthandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * The **`mask`** CSS shorthand property hides an element (partially or fully) by masking or clipping the image at specific points.
   *
   * **Syntax**: `[ <ma> || <position> [ / <bg-size> ]? || <repeat-style> || [ <box> | border | padding | content | text ] || [ <box> | border | padding | content ] ]#`
   */
...
export interface StandardLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `alpha`
   */
  "ma-mode"?: Property.MaskBorderMode | undefined;
  /**
   * The **`ma-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-outset
   */
  "ma-outset"?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`ma-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-repeat
   */
  "ma-repeat"?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`ma-slice`** CSS property divides the image set by `ma-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-slice
   */
  "ma-slice"?: Property.MaskBorderSlice | undefined;
  /**
   * The **`ma-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-source
   */
  "ma-source"?: Property.MaskBorderSource | undefined;
  /**
   * The **`ma-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma-width
   */
  "ma-width"?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`ma`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   * **Syntax**: `[ <geometry-box> | no-clip ]#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskClip | undefined;
  /**
   * The **`ma`** CSS property represents a compositing operation used on the current mask layer with the mask layers below it.
   *
   * **Syntax**: `<compositing-operator>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskComposite | undefined;
  /**
   * The **`ma`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `ma` property.
   *
   * **Syntax**: `<ma>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskImage | undefined;
  /**
   * The **`ma`** CSS property sets whether the mask reference defined by `ma` is treated as a luminance or alpha mask.
   *
   * **Syntax**: `<masking-mode>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskMode | undefined;
  /**
   * The **`ma`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `<geometry-box>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskOrigin | undefined;
  /**
   * The **`ma`** CSS property sets the initial position, relative to the mask position layer set by `ma`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskPosition<TLength> | undefined;
  /**
   * The **`ma`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskRepeat | undefined;
  /**
   * The **`ma`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskSize<TLength> | undefined;
  /**
   * The **`ma`** CSS property sets whether an SVG `<mask>` element is used as a _luminance_ or an _alpha_ mask. It applies to the `<mask>` element itself.
   *
   * **Syntax**: `luminance | alpha`
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskType | undefined;
  /**
   * This feature is not Baseline because it does not work in some of the most widely-used browsers.
   *
   * **Syntax**: `[ pack | next ] || [ definite-first | ordered ]`
...
export interface StandardShorthandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * @see https://developer.mozilla.org/docs/Web/CSS/ma
   */
  "ma"?: Property.MaskBorder | undefined;
  /**
   * The **`offset`** CSS shorthand property sets all the properties required for animating an element along a defined path.
   *
   * **Syntax**: `[ <'offset-position'>? [ <'offset-path'> [ <'offset-distance'> || <'offset-rotate'> ]? ]? ]! [ / <'offset-anchor'> ]?`
...
export interface VendorLonghandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Initial value**: `scroll`
   */
  "-webkit-ma"?: Property.WebkitMaskAttachment | undefined;
  /**
   * The **`ma-outset`** CSS property specifies the distance by which an element's mask border is set out from its border box.
   *
   * **Syntax**: `[ <length> | <number> ]{1,4}`
   ...
   * **Initial value**: `0`
   */
  "-webkit-ma-image-outset"?: Property.MaskBorderOutset<TLength> | undefined;
  /**
   * The **`ma-repeat`** CSS property sets how the edge regions of a source image are adjusted to fit the dimensions of an element's mask border.
   *
   * **Syntax**: `[ stretch | repeat | round | space ]{1,2}`
   ...
   * **Initial value**: `stretch`
   */
  "-webkit-ma-image-repeat"?: Property.MaskBorderRepeat | undefined;
  /**
   * The **`ma-slice`** CSS property divides the image set by `ma-source` into regions. These regions are used to form the components of an element's mask border.
   *
   * **Syntax**: `<number-percentage>{1,4} fill?`
   ...
   * **Initial value**: `0`
   */
  "-webkit-ma-image-slice"?: Property.MaskBorderSlice | undefined;
  /**
   * The **`ma-source`** CSS property sets the source image used to create an element's mask border.
   *
   * **Syntax**: `none | <image>`
   ...
   * **Initial value**: `none`
   */
  "-webkit-ma-image-source"?: Property.MaskBorderSource | undefined;
  /**
   * The **`ma-width`** CSS property sets the width of an element's mask border.
   *
   * **Syntax**: `[ <length-percentage> | <number> | auto ]{1,4}`
   ...
   * **Initial value**: `auto`
   */
  "-webkit-ma-image-width"?: Property.MaskBorderWidth<TLength> | undefined;
  /**
   * The **`ma`** CSS property determines the area which is affected by a mask. The painted content of an element must be restricted to this area.
   *
   * **Syntax**: `[ <box> | border | padding | content | text ]#`
   ...
   * **Initial value**: `border`
   */
  "-webkit-ma"?: Property.WebkitMaskClip | undefined;
  /**
   * The **`-webkit-ma`** property specifies the manner in which multiple mask images applied to the same element are composited with one another. Mask images are composited in the opposite order that they are declared with the `-webkit-ma` property.
   *
   * **Syntax**: `<composite-style>#`
   ...
   * **Initial value**: `source-over`
   */
  "-webkit-ma"?: Property.WebkitMaskComposite | undefined;
  /**
   * The **`ma`** CSS property sets the image that is used as mask layer for an element. By default this means the alpha channel of the mask image will be multiplied with the alpha channel of the element. This can be controlled with the `ma` property.
   *
   * **Syntax**: `<ma>#`
   ...
   * **Initial value**: `none`
   */
  "-webkit-ma"?: Property.WebkitMaskImage | undefined;
  /**
   * The **`ma`** CSS property sets the origin of a mask.
   *
   * **Syntax**: `[ <box> | border | padding | content ]#`
   ...
   * **Initial value**: `padding`
   */
  "-webkit-ma"?: Property.WebkitMaskOrigin | undefined;
  /**
   * The **`ma`** CSS property sets the initial position, relative to the mask position layer set by `ma`, for each defined mask image.
   *
   * **Syntax**: `<position>#`
   ...
   * **Initial value**: `0% 0%`
   */
  "-webkit-ma"?: Property.WebkitMaskPosition<TLength> | undefined;
  /**
   * The `-webkit-ma-x` CSS property sets the initial horizontal position of a mask image.
   *
   * **Syntax**: `[ <length-percentage> | left | center | right ]#`
   ...
   * **Initial value**: `0%`
   */
  "-webkit-ma-x"?: Property.WebkitMaskPositionX<TLength> | undefined;
  /**
   * The `-webkit-ma-y` CSS property sets the initial vertical position of a mask image.
   *
   * **Syntax**: `[ <length-percentage> | top | center | bottom ]#`
   ...
   * **Initial value**: `0%`
   */
  "-webkit-ma-y"?: Property.WebkitMaskPositionY<TLength> | undefined;
  /**
   * The **`ma`** CSS property sets how mask images are repeated. A mask image can be repeated along the horizontal axis, the vertical axis, both axes, or not repeated at all.
   *
   * **Syntax**: `<repeat-style>#`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-ma"?: Property.WebkitMaskRepeat | undefined;
  /**
   * The `-webkit-ma-x` property specifies whether and how a mask image is repeated (tiled) horizontally.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-ma-x"?: Property.WebkitMaskRepeatX | undefined;
  /**
   * The `-webkit-ma-y` property sets whether and how a mask image is repeated (tiled) vertically.
   *
   * **Syntax**: `repeat | no-repeat | space | round`
   ...
   * **Initial value**: `repeat`
   */
  "-webkit-ma-y"?: Property.WebkitMaskRepeatY | undefined;
  /**
   * The **`ma`** CSS property specifies the sizes of the mask images. The size of the image can be fully or partially constrained in order to preserve its intrinsic ratio.
   *
   * **Syntax**: `<bg-size>#`
   ...
   * **Initial value**: `auto auto`
   */
  "-webkit-ma"?: Property.WebkitMaskSize<TLength> | undefined;
  /**
   * The **`max-inline-size`** CSS property defines the horizontal or vertical maximum size of an element's block, depending on its writing mode. It corresponds to either the `max-width` or the `max-height` property, depending on the value of `writing-mode`.
   *
   * **Syntax**: `<'max-width'>`
...
export interface VendorShorthandPropertiesHyphen<TLength = (string & {}) | 0, TTime = string & {}> {
   ...
   * **Syntax**: `<'ma-source'> || <'ma-slice'> [ / <'ma-width'>? [ / <'ma-outset'> ]? ]? || <'ma-repeat'> || <'ma-mode'>`
   */
  "-webkit-ma-image"?: Property.MaskBorder | undefined;
  /**
   * The **`text-emphasis`** CSS property applies emphasis marks to text (except spaces and control characters). It is a shorthand for `text-emphasis-style` and `text-emphasis-color`.
   *
   * **Syntax**: `<'text-emphasis-style'> || <'text-emphasis-color'>`
