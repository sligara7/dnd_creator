...
class Character(Base):
    ...
    # Relationships
    journal_entries = relationship("JournalEntry", back_populates="character", cascade="all, delete")
    inventory_items = relationship("InventoryItem", back_populates="character", cascade="all, delete")
...
class JournalEntry(Base):
    ...
    experience_entries = relationship("ExperienceEntry", back_populates="journal_entry", cascade="all, delete")
    quests = relationship("Quest", back_populates="journal_entry", cascade="all, delete")
    npc_relationships = relationship("NPCRelationship", back_populates="journal_entry", cascade="all, delete")
...
class ExperienceEntry(Base):
    ...
    id = Column(PGUUID, primary_key=True, default=uuid4)
    journal_entry_id = Column(PGUUID, ForeignKey("journal_entries.id", ondelete="CASCADE"), nullable=False)
